	...
	return (
		<section className="aboutSection" id="homepage-aboutus">
			<div className="aboutContent">
				<h2>About us</h2>
				<p>
					We are a team of highly motivated revolutionaries, dedicated towards revolutionizing the restaurant industry by transforming the way your customers order at
					your restaurant - by going contactless and paperless.
				</p>
